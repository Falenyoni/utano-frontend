...
import { getUsers, createUser, deactivateUser, ROLES, type CreateUserRequest } from './usersApi'
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700">
              <tr>
                ...
                <th className="text-left px-4 py-2 font-medium text-gray-500 dark:text-gray-400">Role</th>

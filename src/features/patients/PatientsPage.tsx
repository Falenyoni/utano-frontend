...
export function PatientsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {error && <div className="text-sm text-red-600 dark:text-red-400">Failed to load patients. Please try again.</div>}

      {data && data.data.length === 0 && (
        <div className="text-sm text-gray-400 dark:text-gray-500">No patients found.</div>
      )}
            ...
            {data.data.map((patient) => (
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">{patient.nationalId}</p>
                </div>
      ...
      {data && data.totalPages > 1 && (
        <div className="flex items-center gap-3">
          <button
            ...
            className="px-3 py-1.5 text-sm border border-gray-300 dark:border-gray-700 text-gray-700 dark:text-gray-300 rounded-md disabled:opacity-40"
          >
            Previous
          </button>
